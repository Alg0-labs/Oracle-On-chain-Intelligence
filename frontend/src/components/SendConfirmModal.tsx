...
function Row({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '10px 0', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      <span style={{ fontSize: 13, color: '#E8E8E0', fontFamily: 'monospace', maxWidth: 260, textAlign: 'right', wordBreak: 'break-all' }}>{value}</span>
    </div>
  )
}
...
const titleStyle: React.CSSProperties = { fontSize: 14, color: '#E8E8E0', fontWeight: 700, letterSpacing: 1 }
const closeBtn: React.CSSProperties  = { background: 'none', border: 'none', color: '#555', cursor: 'pointer', fontSize: 16 }
...
const cancelBtn: React.CSSProperties = {
  ...
  color: '#888', fontFamily: "'IBM Plex Mono', monospace", fontSize: 13, cursor: 'pointer',
}
