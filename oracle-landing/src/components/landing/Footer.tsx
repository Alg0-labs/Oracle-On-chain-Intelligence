...
const CHAIN_BADGES = [
  { val: 'ETH', label: 'Mainnet' },
  { val: 'ARB', label: 'Arbitrum' },
  { val: 'POL', label: 'Polygon' },
]
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            On-chain intelligence, distilled. The AI layer your crypto
            wallet has always needed.
          </p>

          {/* Chain badges */}
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            {CHAIN_BADGES.map(b => (
              <ChainBadge key={b.val} val={b.val} label={b.label} />
            ))}
          </div>
        </div>
...
function ChainBadge({ val, label }: { val: string; label: string }) {
  return (
    <div
      style={{
        padding:      '5px 12px',
